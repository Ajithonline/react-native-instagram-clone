            ...
            <View style={styles.container}>
              ...
              <ScrollView horizontal={true}>
                  <View style={styles.myStoryImageWrapper}>
                    <Image style={styles.myStoryImage}   source={require('../assets/images/face.jpeg')} />
                    <Text style={styles.profileName}>Catherin</Text>
                 </View>
                 <View style={styles.otherStoryImageWrapper}>
                    <Image style={styles.storyRound}   source={require('../assets/images/storiescircle.png')} />
                    <Image style={styles.otherStories}   source={require('../assets/images/face.jpeg')} />
                    <Text style={styles.profileName}>Seona</Text>
                 </View>
                 <View style={styles.otherStoryImageWrapper}>
                    <Image style={styles.storyRound}   source={require('../assets/images/storieslivecircle.png')} />
                    <Image style={styles.otherStories}   source={require('../assets/images/face.jpeg')} />
